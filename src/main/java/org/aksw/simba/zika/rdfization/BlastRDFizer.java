...
public class BlastRDFizer {
	...
	public static void main(String[] args) throws RepositoryException, RDFHandlerException, IOException {
		...
		rdfizeBlast(blastScoreFile,blastAlignFile);
	}
	/**
	 ...
	 */
	public static void rdfizeBlast(String blastScoreFile, String blastAlignFile) throws IOException, RepositoryException, RDFHandlerException {
		initializeRepo();
