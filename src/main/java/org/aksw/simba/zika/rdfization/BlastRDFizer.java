...
public class BlastRDFizer {
 ...
 public static String res = "http://aksw.org/zika/resource/";
 public static String vocab = "http://aksw.org/zika/schema/";
 ...
 public static ValueFactory factory;
	...
	public static void main(String[] args) throws RepositoryException, RDFHandlerException, IOException {
		    ...
		    String blastAlignFileDir = "D:/eclipse-mars-workspace/Zika/data/step1_blast/tordfize/Alignments.txt";

       rdfizeBlast(blastScoreFile,blastAlignFileDir);

	}

	private static void rdfizeBlast(String blastScoreFile, String blastAlignFile) throws IOException, RepositoryException, RDFHandlerException {
		  initializeRepo();
	...
	private static void writeModel() throws RepositoryException, FileNotFoundException, RDFHandlerException {
		RepositoryResult<Statement> statements =  conn.getStatements(null, null, null, true);
	    Model model = Iterations.addAll(statements, new LinkedHashModel());
	    OutputStream output = new FileOutputStream(new File("zika.ttl"));
		Rio.write(model, output, RDFFormat.TURTLE);
		System.out.println("RDFization is completed. Output written to zika.ttl");
		
	}

	private static void addBlastAlignments(String refNo, String blastAlignFile) throws IOException, RepositoryException {
